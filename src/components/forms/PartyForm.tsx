        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              className="placeholder:text-muted-foreground border-input w-full min-h-[80px] rounded-md border bg-white/80 px-3 py-2 text-base shadow-xs transition-[color,box-shadow] outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] md:text-sm"
              onInput={(e) => {
